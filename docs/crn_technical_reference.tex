...
\emph{Pending.} Will follow the structure of the nozzle technical reference: separating
what is a physical law, what is a numerical approximation, what is an empirical
calibration, and what is simply unmodeled.

\section{Basic Vocabulary for a New Reader}
\emph{Pending.} Reactors, residence time, equivalence ratio, ignition delay, emission
index, and the difference between a reactor network and a computational fluid dynamics
simulation.
